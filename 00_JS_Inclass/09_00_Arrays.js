...
console.log(isimler.at(-2));

//!  Diziye veri yazma
// const isimler = ["ahmet", "ismet", "can", "canan", "Matheww"];
isimler[1] = "saffet"; // 1. index'deki elemanı yeni atanan ile değiştirdi.
console.log(isimler);
...
//* splice()
// listeye eleman ekleme ve eleman silme için kullanılabilir. iki parametre ile kullanılırsa 1. parametre silmeye nerden başlanacağı, ikinci parametre kaç eleman silineceğini ifade eder.
...
array1.fill(1, 2, 4); // 2-4 arası index'deki elemanları 1 yap.
console.log(array1);
...
const yeniArabalar = arabalar1.slice(2); // 2. index'den başla geri kalanını yazdır.
